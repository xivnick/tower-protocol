...
begin
  ...
  if position(E'  if hunt_state.is_defeat_recovery and hunt_state.player_recovery_started_at + interval ''10 seconds'' > encountered_at then raise exception ''hunt_defeat_recovery''; end if;' in definition) = 0 then
