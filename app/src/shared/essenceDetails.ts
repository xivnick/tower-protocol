...
export const ESSENCE_DETAILS: Record<string, { summary: string; effects: string[] }> = {
  "artificial-strike": { summary: "즉시 물리 피해", effects: ["CD 8.0초 · 물리 공격력 50% 피해", "CD 5.0초 · 물리 공격력 65% 피해", "CD 5.0초 · 물리 공격력 100% 피해", "CD 4.0초 · 물리 공격력 120% 피해 · 적중 후 물리 공격력 +5%", "CD 4.0초 · 물리 공격력 145% 피해 · 적중 후 물리 공격력 +8%"] },
  ...
  "artificial-bolt": { summary: "즉시 마법 피해", effects: ["CD 8.0초 · 마법 공격력 50% 피해", "CD 5.0초 · 마법 공격력 65% 피해", "CD 5.0초 · 마법 공격력 100% 피해", "CD 4.0초 · 마법 공격력 120% 피해 · 적중 후 마법 공격력 +5%", "CD 4.0초 · 마법 공격력 145% 피해 · 적중 후 마법 공격력 +8%"] },
  "artificial-knowledge": { summary: "마법 공격력 보정", effects: ["패시브 · 마법 공격력 +2%", "패시브 · 마법 공격력 +4%", "패시브 · 마법 공격력 +6%", "패시브 · 마법 공격력 +7% · 마법 피해 +3%", "패시브 · 마법 공격력 +8% · 마법 피해 +5%"] },
  "artificial-armor": { summary: "방어력 보정", effects: ["패시브 · 방어력 +3%", "패시브 · 방어력 +6%", "패시브 · 방어력 +9%", "패시브 · 방어력 +10% · 받는 물리 피해 -3%", "패시브 · 방어력 +12% · 받는 물리 피해 -5%"] },
  ...
  "artificial-life": { summary: "최대 HP 보정", effects: ["패시브 · 최대 HP +2%", "패시브 · 최대 HP +4%", "패시브 · 최대 HP +6%", "패시브 · 최대 HP +7% · 받는 회복량 +3%", "패시브 · 최대 HP +8% · 받는 회복량 +5%"] },
