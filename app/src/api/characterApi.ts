...
export type HuntLogEntry = {
  timeTenths: number;
  kind: "encounter" | "attack" | "critical" | "miss" | "regeneration" | "player_regeneration" | "defeat" | "fled" | "timeout" | "enemy_attack" | "enemy_miss" | "player_defeat" | "reflect" | "essence_cast" | "essence_damage" | "essence_shield" | "shield_absorb" | "essence_extra_hit" | "essence_reflect";
  amount: number;
  targetHp: number;
  target?: "enemy" | "player";
  source?: "player" | "enemy";
