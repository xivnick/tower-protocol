...
import { EquipmentComparison, getArmorComparisonEntries } from "./EquipmentComparison";

const armorNames: Record<ArmorType, string> = { plate: "중갑", leather: "경갑", robe: "로브" };
type ArmorFilter = "all" | ArmorType;

export function ArmorEquipmentPanel({ character, equippedWeapon, onCharacterChange, onEquippedArmorChange, refreshKey = 0 }: {
  character: Character;
